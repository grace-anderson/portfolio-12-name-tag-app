...
class App extends Component {
  ...
  //finish making name tag generator interactive
  //this is creating a new method called addName
  addName = (name) => {
    const addNames = [name, ...this.state.names];
    this.setState({ names: addNames });
  };
  //
  render() {
    return (
